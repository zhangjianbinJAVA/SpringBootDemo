...
@SpringBootTest
public class LearnController7Test {
    ...
    public void qryLearn() throws Exception {
        ...
        // 判断 learnService.selectByKey 方法 就否调用了
        Mockito.verify(learnService).selectByKey(1001L);

        // 判断 learnService.selectByKey 方法，调用了 2 次
        // Mockito.atLeast 最少几次，Mockito.atMost 是多几次 等判断函数
        Mockito.verify(learnService, Mockito.atMost(2)).selectByKey(1001L);
